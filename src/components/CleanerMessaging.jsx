...
/*
 * ============================================================================
 * CLEANER MESSAGING SYSTEM (Booking-Scoped)
 * ============================================================================
 * 
 * Purpose:
...
import {
    ...
    MessageSquare, Loader, Lock, Zap, Calendar, MapPin
} from 'lucide-react';
...
export default function CleanerMessaging({ onBack, initialBookingId }) {
    const { user } = useApp();
        ...
        <div className="min-h-screen bg-gray-50 pb-24">
            ...
            <div className="app-bar flex items-center justify-between px-4 py-3">
                ...
                <div className="w-10 relative">
                    {totalUnread > 0 && (
                        <span className="absolute -top-1 -right-1 w-5 h-5 bg-secondary-500 rounded-full flex items-center justify-center text-xs text-white font-bold">
                            {totalUnread}
                        </span>
                    )}
                </div>
