 ...
 * - Integration with Booking Status (Closed chats for completed jobs).
 * 
 * Architecture:
 * Mirrors `CleanerMessaging` but scoped to the Customer's perspective.
 */
